...
def init_db():
    ...
    try:
        ...
        dev1 = DevORM(
            name="Nintendo", 
            image_url="https://upload.wikimedia.org/wikipedia/commons/thumb/9/95/Nintendo_Logo_2017.png/960px-Nintendo_Logo_2017.png"
        )
        dev2 = DevORM(
            name="CD Projekt Red", 
            image_url="https://www.cdprojekt.com/en/wp-content/uploads-en/2016/01/cdp_004-1024x760-1024x760.jpg"
        )
        dev3 = DevORM(
            name="FromSoftware", 
            image_url="https://static0.thegamerimages.com/wordpress/wp-content/uploads/sharedimages/2025/02/fromsoftware-logo.jpg?q=50&fit=contain&w=280&dpr=1.5"
        )
        ...
        default_videogames =[
            ...
            VideogameORM(title="Pac-Man World RePac", description="Modernización del clásico Pac-Man con laberintos dinámicos, velocidad creciente y efectos visuales llamativos que amplifican la experiencia arcade.", cover_url="https://files.gamesfull.app/uploads/image/2022/08/Pac-Man-World-RePac.jpg", genre_id=7 ),
